  ...
  const SCENES = {
    ...
    wechsel: {
      ...
      draw(g) {
        ...
        line(g, 355, 190, 565, 190, 'L'); line(g, 355, 320, 565, 320, 'L');
        line(g, 300, 250, 355, 190, 'L'); line(g, 300, 250, 355, 320, 'L');
        line(g, 565, 190, 620, 250, 'L'); line(g, 565, 320, 620, 250, 'L');
        line(g, 620, 250, 770, 280, 'L');
